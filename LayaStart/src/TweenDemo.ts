class TweenDemo {
    ...
    private createTween(): void {
        ...
        var offsetX: number = Laya.stage.width - w >> 2;
        //显示的字符串
        var demoString: string = "L";
    ...
    private updateColor(txt: Laya.Text, delay: number, start_time: number): void {
